...
python3 scripts/monitor-standards.py --dir /path/to/your/app        # 10 technical standards (ISO, OWASP, NIST, CIS)
...
| `scripts/monitor-standards.py` | Monitors 10 technical standards (ISO 27001, ISO 27701, ISO 42001, ISO 31000, ISO 9001, IEC, OWASP, NIST AI RMF, NIST CSF, CIS Benchmarks) |
