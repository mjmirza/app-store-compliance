...
| --- | --- | --- | --- | --- |
| APPLE-2.3-FUTURE-FUNCTIONALITY | MEDIUM | Future functionality language found | Describe only what the build does today (fastlane precheck future_functionality, Apple 2.3.1). | AGENTS.md<br>references/rules/metadata.md<br>docs/APPLE.md<br>docs/OPEN-SOURCE-PATTERNS.md |
...
| APPLE-2.3-CROSS-PLATFORM-REFERENCE | HIGH |  | Refer to guidelines for remediation. | CHANGELOG.md<br>AGENTS.md<br>RELEASE-READINESS-REPORT.md<br>README.md<br>references/README.md<br>... and 21 more files |
...
| Finding ID | Severity | Description | Required Action | Affected Files |
| --- | --- | --- | --- | --- |
| BOTH-LOOTBOX-ODDS | HIGH | Random reward mechanic present | Disclose the odds for every random reward before purchase (Apple 3.1.1, Google gambling). | AGENTS.md<br>RELEASE-READINESS-REPORT.md<br>README.md<br>references/guidelines/by-app-type/subscriptions-and-in-app-purchase.md<br>references/guidelines/by-app-type/games.md<br>... and 8 more files |
