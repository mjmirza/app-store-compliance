...
## 6. Risk assessment
- *Google Play Developer Policies*: Non-compliance may lead to rejection, limited visibility, or account suspension.
- *Play Console announcements*: Unverified developer accounts will face publishing blocks and listing removal.
...
## 7. Migration steps
- **Google Play Developer Policies**: Review Google Play Policy Center updates; audit app metadata, in-app experience, and content ratings.
- **Play Console announcements**: Complete mandatory developer account identity verification and monitor Play Console inbox alerts.
