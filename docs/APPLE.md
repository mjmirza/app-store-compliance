...
- Rosetta sunset. Apple's 1 September 2026 notice says macOS 27 is the final release to support Rosetta, and its 9 September 2026 submissions notice says macOS 26 is the final release supporting Intel Macs and Rosetta, with macOS 27 Apple silicon only. Ship a native arm64 build before macOS 27 either way. [Apple](https://developer.apple.com/news/?id=w5ngl9k2), [Apple](https://developer.apple.com/news/?id=k1mtkt1k)
- Starting April 2027 uploads must be built with the iOS 27, iPadOS 27, tvOS 27, visionOS 27, or watchOS 27 SDK or later. Apple named the month, not the day. Xcode 27 shipped as a Release Candidate on 9 September 2026. [Apple](https://developer.apple.com/news/?id=k1mtkt1k)
- App Store Connect, 19 August 2026. The App Review contact phone number must be in international format (for example +852), and the first consumable, non-consumable, auto-renewable subscription, and non-renewing subscription must each be submitted with a new app version. The 9 September 2026 update added screenshot specifications for iPhone Duo, iPhone 18 Pro and Pro Max, Apple Watch Ultra 4, and Apple Watch Series 12. [Apple](https://developer.apple.com/help/app-store-connect/release-notes/)
...
Two App Store Connect form rules apply since 19 August 2026. The App Review contact phone number is entered in international format with the country code, for example +852, not as digits only. The first consumable, the first non-consumable, the first auto-renewable subscription, and the first non-renewing subscription are each submitted together with a new app version. After that, further items of the same type do not need a new version as long as the app has an approved version. [Apple](https://developer.apple.com/help/app-store-connect/release-notes/)
