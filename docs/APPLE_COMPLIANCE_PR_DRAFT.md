...
- Official announcement title: *"Important updates concerning App Store Review Guidelines"* (Source: Priority 1 (Verified))
...
2. Ensure App Review Notes are updated with working test accounts.
2. Verify the application flows align with the updated guideline numbers.
