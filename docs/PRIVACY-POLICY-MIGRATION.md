...
### 1. [Advertising ID] Google Play Advertising ID Policy and com.google.android.gms.permission.AD_ID
...
### 2. [App Tracking Transparency] App Tracking Transparency Framework Reinforcement
...
### 3. [Background location] Google Play Restriction on ACCESS_BACKGROUND_LOCATION Permission
...
### 4. [Cookie consent] ePrivacy Directive Cookie Consent Banner Requirements
...
### 5. [Data Safety] Google Play Store Data Safety Form Compliance Verification
...
### 6. [GDPR] European Union General Data Protection Regulation Enforcement Guidelines
...
### 7. [GDPR] Unverified Industry Blog Rumors on GDPR Fines
...
### 8. [Health permissions] Google Play Health Connect Integration and Fitness Permissions
...
### 9. [IndexedDB] IndexedDB Structured Client-Side Databases and User Consent Control
...
### 10. [Local storage] Secure Client-Side Local Storage Guidelines under GDPR
...
### 11. [Privacy Manifest] Apple Mandatory Privacy Manifest Requirements for App Store Submissions
...
### 12. [Privacy Nutrition Labels] Apple App Store Privacy Nutrition Labels Questionnaire Update
...
### 13. [Required Reason APIs] Apple Stricter Required Reason API Usage Guidelines
...
### 14. [Runtime permissions] Android Runtime Permission Model and Dynamic Checks
...
### 15. [Session storage] Temporary Browser Session Storage Security Recommendations
...
### 16. [Tracking technologies] Tracking Technologies, Scripts, and Invisible Pixels Consent Management
...
### 17. [User Data Policy] Google Play User Data Protection and Deletion Policy
...
- **Regulatory Impact**: High priority compliance area.
- [ ] **Task 1**: Ensure background location is backed by a persistent prominent in-app disclosure view.
