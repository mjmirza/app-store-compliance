...
| --- | --- | --- | --- |
| Permissions | PASSED | 0 | Lead Mobile Developer, Platform Security Lead |
| Privacy disclosures | ADVISORY | 1 | Data Protection Officer (DPO), Legal Counsel (Privacy) |
| Screenshots | PASSED | 0 | App Store Optimization (ASO) Specialist, Product Designer |
| Metadata | BLOCKED | 23 | Product Marketing Manager (PMM), ASO Specialist |
| Age rating | PASSED | 0 | Content Ratings Officer, Legal Counsel |
| AI disclosures | PASSED | 0 | AI Ethics and Governance Committee, Lead AI Architect |
| Subscription disclosures | ADVISORY | 1 | Monetization Lead, Product Legal Counsel |
| Payment compliance | PASSED | 0 | Fintech Architect, Payment Operations Lead |
| Accessibility | PASSED | 0 | Accessibility Specialist, Frontend QA Lead |
| Legal documents | ADVISORY | 2 | Legal Counsel (Commercial/IP), Compliance Officer |
| Support URL | PASSED | 0 | Customer Support Operations Lead, Web Admin |
| Privacy policy | ADVISORY | 1 | Data Protection Officer (DPO), Compliance Lead |
| Terms of service | ADVISORY | 1 | Legal Counsel (Commercial), Product Lead |
| Export compliance | PASSED | 0 | Global Trade & Export Compliance Officer |
| Encryption declarations | PASSED | 0 | Security Engineering Lead, Cryptography Specialist |

## Detailed Compliance Analysis

### 1. Permissions
- Status: PASSED
- Recommended Reviewers: Lead Mobile Developer, Platform Security Lead
...
### 3. Screenshots
- Status: PASSED
- Recommended Reviewers: App Store Optimization (ASO) Specialist, Product Designer
...
| APPLE-2.3-CROSS-PLATFORM-REFERENCE | HIGH |  | Refer to guidelines for remediation. | CHANGELOG.md<br>AGENTS.md<br>README.md<br>references/README.md<br>references/guidelines/by-app-type/subscriptions-and-in-app-purchase.md<br>... and 28 more files |

### 5. Age rating
- Status: PASSED
- Recommended Reviewers: Content Ratings Officer, Legal Counsel
...
- Status: ADVISORY
- Recommended Reviewers: Monetization Lead, Product Legal Counsel
...
- Status: PASSED
- Recommended Reviewers: Fintech Architect, Payment Operations Lead
...
### 11. Support URL
- Status: PASSED
- Recommended Reviewers: Customer Support Operations Lead, Web Admin

No outstanding risks found for this area.

### 12. Privacy policy
- Status: ADVISORY
- Recommended Reviewers: Data Protection Officer (DPO), Compliance Lead
...
### 13. Terms of service
- Status: ADVISORY
- Recommended Reviewers: Legal Counsel (Commercial), Product Lead
...
- Status: PASSED
- Recommended Reviewers: Global Trade & Export Compliance Officer

No outstanding risks found for this area.

### 15. Encryption declarations
- Status: PASSED
- Recommended Reviewers: Security Engineering Lead, Cryptography Specialist
