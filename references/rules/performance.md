...
```bash
grep -rnE 'ageCategory|minorUser|parentalConsent|DeclaredAgeRange|age-signals' . && ! grep -rqE 'verifyParentalConsent|handleAgeCategorySignal|rescindConsent|deleteAgeVerificationData' .
```
