...
```bash
grep -rqn 'DeclaredAgeRange\|age-signals\|com.google.android.play:age-signals' . && ! grep -rqn 'verifyParentalConsent\|handleAgeCategorySignal\|rescindConsent\|deleteAgeVerificationData' .
```
