...
def main():
    ...
    if approaching:
        print(f"⚠️  APPROACHING REGULATORY DEADLINES (Active soon):")
        print("=" * 80)
        ...
        print("✅ No new regulatory deadlines approaching within the next 90 days.\n")

    # Print Enforced/Active Checklist Summary
    if enforced:
        print(f"📋 ACTIVE & ENFORCED REGULATORY REQUIREMENTS:")
        print("=" * 80)
