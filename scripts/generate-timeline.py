...
def main():
    ...
    now = datetime.datetime.now(timezone.utc) if hasattr(datetime, "timezone") else datetime.now(timezone.utc)
    parsed_items = []
    ...
    if not overdue_warnings and not approaching_warnings:
        ...
        if overdue_warnings:
            ...
            md_lines.append("")
            md_lines.append("| Priority | Jurisdiction | Law | Requirement | Effective Date | Grace Period | Mandatory Date | Enforcement Date | Overdue Days | Affected Repository Sections |")
            md_lines.append("|---|---|---|---|---|---|---|---|---|---|")
            for item in overdue_warnings:
                overdue_days = abs(item["remaining_days"])
                md_lines.append(
        ...
        if approaching_warnings:
            ...
            md_lines.append("")
            md_lines.append("| Priority | Jurisdiction | Law | Requirement | Effective Date | Grace Period | Mandatory Date | Enforcement Date | Days Remaining | Affected Repository Sections |")
            md_lines.append("|---|---|---|---|---|---|---|---|---|---|")
            for item in approaching_warnings:
                md_lines.append(
    ...
    md_lines.append("")
    md_lines.append("| Jurisdiction | Law | Requirement | Effective Date | Grace Period | Mandatory Date | Enforcement Date | Priority | Affected Repository Sections |")
    md_lines.append("|---|---|---|---|---|---|---|---|---|")
    for item in parsed_items:
        md_lines.append(
            f"| {item['jurisdiction']} | {item['law']} | {item['requirement']} | {item['effective_date']} | {item['grace_period']} | {item['mandatory_date']} | {item['enforcement_date']} | {item['priority'].upper()} | {item['affected_repository_sections']} |"
        )
    md_lines.append("")
