...
[
  {
    "id": "STD-MOCK-TEST-27001",
    "category": "ISO 27001",
    "title": "ISO 27001 ISMS Compliance Standard Update",
    "description": "Essential updates requiring enhanced access control policies and systematic auditing logs.",
    "link": "https://www.iso.org/standard/27001",
    "pubDate": "Fri, 15 May 2026 10:00:00 PDT"
  },
  {
    "id": "STD-MOCK-TEST-27701",
    "category": "ISO 27701",
    "title": "ISO/IEC 27701 Privacy Information Management Extension",
    "description": "Privacy information extensions for PIMS consent manager tracking guidelines.",
...
if grep -q "ISO 27001 ISMS Compliance Standard" /tmp/monitor_standards_run.log && grep -q "ISO/IEC 27701 Privacy Information" /tmp/monitor_standards_run.log; then
...
if [ -f "$OUT_DOCS" ]; then
  ...
  if grep -q "ISO 27001 ISMS Compliance Standard" "$OUT_DOCS" && grep -q "ISO/IEC 27701 Privacy Information" "$OUT_DOCS"; then
