...
[
  {
    "id": "STAND-MOCK-TEST-ISO27001",
    "category": "ISO 27001",
    "title": "ISO 27001 Compliance Guidelines on ISMS Auditing",
    "description": "Essential ISO 27001 regulations require robust access control policies and dynamic audits.",
    "link": "https://www.iso.org/standard/27001",
    "pubDate": "Fri, 15 May 2026 10:00:00 PDT"
  },
  {
    "id": "STAND-MOCK-TEST-ISO27701",
    "category": "ISO 27701",
    "title": "ISO 27701 Privacy Information Management Guidelines",
    "description": "Organizations must transition their systems to ensure strict privacy-information-management controls.",
...
if grep -q "ISO 27001 Compliance Guidelines" /tmp/monitor_standards_run.log && grep -q "ISO 27701 Privacy Information" /tmp/monitor_standards_run.log; then
...
if [ -f "$OUT_DOCS" ]; then
  ...
  if grep -q "ISO 27001 Compliance Guidelines" "$OUT_DOCS" && grep -q "ISO 27701 Privacy Information" "$OUT_DOCS"; then
