...
[
  {
    ...
    "category": "ISO 27001",
    "title": "ISO 27001 Security Management Audit Guidance",
    "description": "Essential ISMS rules require updated threat intelligence and cloud security controls.",
  ...
  },
  {
    ...
    "category": "OWASP",
    "title": "OWASP Mobile Application Security Verification Update",
    "description": "Updated OWASP MASVS release focusing on secure storage and dynamic resilience.",
...
if grep -q "ISO 27001 Security Management Audit Guidance" /tmp/monitor_standards_run.log && grep -q "OWASP Mobile Application Security Verification Update" /tmp/monitor_standards_run.log; then
...
if [ -f "$OUT_DOCS" ]; then
  ...
  if grep -q "ISO 27001 Security Management Audit Guidance" "$OUT_DOCS" && grep -q "OWASP Mobile Application Security Verification Update" "$OUT_DOCS"; then
