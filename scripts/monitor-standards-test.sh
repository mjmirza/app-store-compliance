...
[
  {
    "id": "STANDARDS-TEST-ISO-27001",
    "category": "ISO 27001",
    "title": "ISO 27001 Information Security Management Standard",
    "description": "Crucial updates requiring ISMS alignment and threat intelligence controls.",
    "link": "https://www.iso.org/isoiec-27001-information-security.html",
    "pubDate": "Fri, 15 May 2026 10:00:00 PDT"
  },
  {
    "id": "STANDARDS-TEST-NIST-CSF",
    "category": "NIST CSF",
    "title": "NIST Cybersecurity Framework Update",
    "description": "NIST CSF 2.0 Governance expansion for cybersecurity risk management.",
...
if grep -q "ISO 27001 Information Security" /tmp/monitor_standards_run.log && grep -q "NIST Cybersecurity Framework" /tmp/monitor_standards_run.log; then
...
if [ -f "$OUT_DOCS" ]; then
  ...
  if grep -q "ISO 27001 Information Security" "$OUT_DOCS" && grep -q "NIST Cybersecurity Framework" "$OUT_DOCS"; then
