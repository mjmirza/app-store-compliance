...
[
  {
    ...
    "category": "ISO 27001",
    "title": "ISO 27001 Information Security Controls Revision",
    "description": "ISO 27001 guidelines mandate revised ISMS Annex A controls.",
  ...
  },
  {
    ...
    "description": "OWASP MASVS standards require enhanced input sanitization and secure storage.",
