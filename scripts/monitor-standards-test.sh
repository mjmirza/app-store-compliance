...
# Verifies mock input parsing, standard keyword matching, codebase scanning,
...
[
  {
    "id": "MOCK-STD-ISO27001-TEST",
    "category": "ISO 27001",
    "title": "ISO/IEC 27001 Information Security Management Update",
    "description": "Crucial ISMS Annex A access control policy updates.",
    "link": "https://www.iso.org/standard/27001",
    "pubDate": "Mon, 01 Jun 2026 09:00:00 GMT",
    "source_trust": "Priority 1"
  },
  {
    "id": "MOCK-STD-NISTAIRMF-TEST",
    "category": "NIST AI RMF",
    "title": "NIST AI Risk Management Framework Guidelines",
    "description": "Updated NIST AI RMF guidance on model explainability and risk mapping.",
